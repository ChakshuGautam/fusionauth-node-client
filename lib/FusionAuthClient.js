...
FusionAuthClient.prototype = {
   ...
   * @return {Promise<ClientResponse<BulkResponse>>} A Promise for the FusionAuth call.
   */
   ...
   * @return {Promise<ClientResponse<BulkResponse>>} A Promise for the FusionAuth call.
   */
  deactivateUsersByQuery: function(queryString, dryRun) {
    return new Promise((resolve, reject) => {
      this._start()
          .uri('/api/user/bulk')
   ...
   * @return {Promise<ClientResponse<BulkResponse>>} A Promise for the FusionAuth call.
   */
  deleteUsersByQuery: function(queryString, dryRun) {
    return new Promise((resolve, reject) => {
      this._start()
          .uri('/api/user/bulk')
          .urlParameter('queryString', queryString)
 ...
 * @property {Object<DeletePolicyType, DeletePolicy>} [deletePolicies]
 * @property {string} [id]
 ...
 *
 * @property {number} [numberOfDaysToRetain]
 * @property {DeletePolicyType} [type]
 */
...
var DeletePolicyType = {
  orphaned: "_exists_:parentEmail",
  unverified: "verified:false",
  unverifiedRegistration: "registrations.verified:false"
};
 ...
 *
 * @property {boolean} [deleteUnverifiedAccounts]
 * @property {number} [deleteUnverifiedAccountsDays]
